...
use App\Filament\Resources\ArtifactResource\RelationManagers\AuthorsRelationManager;
use App\Filament\Resources\ArtifactResource\RelationManagers\CopiesRelationManager;
use App\Filament\Resources\ArtifactResource\RelationManagers\EventsRelationManager;
use App\Filament\Resources\ArtifactResource\RelationManagers\LiteraturesRelationManager;
...
class ArtifactResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Eser';
    protected static ?string $navigationLabel = "Eserler";

    protected static ?string $pluralLabel = 'Eserler';
    ...
    {
        return [
            RelationGroup::make('Artifact', [
                CopiesRelationManager::class,
                AuthorsRelationManager::class,
                LiteraturesRelationManager::class,
            ])

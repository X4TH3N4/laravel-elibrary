...
namespace App\Filament\Resources\ProseResource\RelationManagers;
...
class CopyRelationManager extends RelationManager
{
    protected static string $relationship = 'copy';
    protected static ?string $title = 'Nüshalar';
    protected static ?string $label = 'Nüsha';
    protected static ?string $pluralLabel = 'Nüsha';
